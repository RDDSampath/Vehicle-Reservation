...
export default class twofDay extends Component{
    constructor(props){
        super(props);
        this.state={
            dName :"",
        ...
        return(
            <div className="box">
                <h1 className="h3 mb-3 font-weight-normal">Driver</h1>
                    ...
                    onChange={this.handleChekbox} required/>two Days &nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="11000" 
                    name="dCharges"
                    checked={this.state.dCharges}  
                    onChange={this.handleChekbox} required />LKR. 11000 /=&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="D0005" 
                    name="dId"
                    checked={this.state.dId}  
                    onChange={this.handleChekbox} required/>D0005&nbsp; &nbsp; &nbsp;
                    ...
                    <input class="form-check-input" type="checkbox" value="two Days" 
                    name="dTime"
                    checked={this.state.dTime}  
                    onChange={this.handleChekbox} required/>two Days &nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="14000" 
                    name="dCharges"
                    checked={this.state.dCharges}  
                    onChange={this.handleChekbox} required />LKR. 14000 /=&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="D0019" 
                    name="dId"
                    checked={this.state.dId}  
                    onChange={this.handleChekbox} required/>D0019&nbsp; &nbsp; &nbsp;
                    <button type="form-check-input" class="btn btn-primary"style={{float:'Right',backgroundColor:'green'}}
                    onClick={this.onSubmit}>Select</button>
                    </form>
                    </div>
                    ...
                    checked={this.state.dTime}  
                    onChange={this.handleChekbox} required/>two Days&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="13000" 
                    name="dCharges"
                    checked={this.state.dCharges}  
                    onChange={this.handleChekbox} required />LKR. 13000 /=&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="D0007" 
                    name="dId"
                    checked={this.state.dId}  
                    onChange={this.handleChekbox} required/>D0007&nbsp; &nbsp; &nbsp;
                    <button type="form-check-input" class="btn btn-primary"style={{float:'Right',backgroundColor:'green'}}
                    onClick={this.onSubmit}>Select</button>
                    </form>
                    </div>
                    ...
                    name="dCharges"
                    checked={this.state.dCharges}  
                    onChange={this.handleChekbox} required />LKR. 15000 /=&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="D0040" 
                    name="dId"
                    checked={this.state.dId}  
                    onChange={this.handleChekbox} required/>D0040&nbsp; &nbsp; &nbsp;
                    <button type="form-check-input" class="btn btn-primary"style={{float:'Right',backgroundColor:'green'}}
                    onClick={this.onSubmit}>Select</button>
                    </form>
                    </div>
                    ...
                    checked={this.state.dTime}  
                    onChange={this.handleChekbox} required/>two Days&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="12000" 
                    name="dCharges"
                    checked={this.state.dCharges}  
                    onChange={this.handleChekbox} required />LKR. 12000 /=&nbsp; &nbsp; &nbsp;
                    <input class="form-check-input" type="checkbox" value="D0013" 
                    name="dId"
                    checked={this.state.dId}  
                    onChange={this.handleChekbox} required/>D0013&nbsp; &nbsp; &nbsp;
                    <button type="form-check-input" class="btn btn-primary" style={{float:'Right',backgroundColor:'green'}}
                    onClick={this.onSubmit}>Select</button>
                    </form>
                    </div>
